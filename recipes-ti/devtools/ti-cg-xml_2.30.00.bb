...
SRC_URI = "http://www.sanb.design.ti.com/SDOApps/cg_xml/cg_xml_v${PV}/cg_xml-v${PV}-Linux-x86-Install;name=cgxmlbin"

LIC_FILES_CHKSUM = "file://cg_xml_${PV}_Manifest.pdf;md5=50cbf2725e64e522aea0bb5e112f7995"

SRC_URI[cgxmlbin.md5sum] = "069444a82700a7b2ea54a20198a6b3e3"
SRC_URI[cgxmlbin.sha256sum] = "8dfeebd69b9853233c9f84c2b81b95cd115fdec8d9102ae1e5c641dd20c6876c"
...
ALLOW_EMPTY_${PN} = "1"
FILES_${PN}-dev += "${CG_XML_INSTALL_DIR_RECIPE}"
